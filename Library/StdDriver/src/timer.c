...
/**
  * @brief   timer counter buffer in global variable. 
*/
...
/**
  ...
  * @exmaple :  fsys = 8MHz, delay 6.4ms  : Timer3_AutoReload_Interrupt_Initial(8,6400);
*/
#pragma vector=0x83
...
{
    SFRS = 0;T3CON&=0xF8;T3CON|=0x07;                 /* fix divider 128 */
