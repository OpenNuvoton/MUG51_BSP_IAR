...
//***********************************************************************************************************
//  File Function: MUG51 PWM demo with dead time
//***********************************************************************************************************
#include "MUG51_IAR.h"
...
void main(void)
{
    ALL_GPIO_QUASI_MODE;
/*-----------------------------------------------------------------------------------------------------------------
  PWM frequency   = Fpwm/((PWMPH,PWMPL)+1) = (7.3728MHz/8)/(0x398+1) = 1KHz (1ms)
  PWM4 high duty  = PWM4H,PWM4L = 0x02EE = 1/4 PWM period
  PWM0 high duty  = PWM0H,PMW0L = 0x03CF = 1/2 PWM period
  Dead time       = 0x180 <PDTEN.4+PDTCNT[7:0]>/Fsys = 0x1FF/Fsys = 512/24000000 = 69.4 us (max value)
  Dead time       = 0x180 <PDTEN.4+PDTCNT[7:0]>/Fsys = 0x180/Fsys = 384/24000000 = 52.08 us (sample value)
-----------------------------------------------------------------------------------------------------------------*/
    MFP_P25_PWM0_CH0;
    MFP_P24_PWM0_CH1;
    MFP_P01_PWM0_CH4;
